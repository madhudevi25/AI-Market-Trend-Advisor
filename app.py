  ...
  #--------------------------------------------------------------------------------
    ...
    st.markdown(
        ...
        <div style='color: #2c3e50; font-size: 1.1em; margin-bottom: 0.8rem; line-height: 1.4;'>
                <b>About Me: I help organizations cut weeks of market research into minutes with a responsible AI accelerator that blends real-time insights with built-in bias and fairness auditing. My focus: turning GenAI from a concept into a trusted, decision-ready solution executives can actually use.</b>
            </div>
